...
.preheader52.preheader:
  %4 = tail call i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr() #20
  ...
  %9 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 33, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
...
11:                                               ; preds = %.preheader52.preheader
  %12 = and i64 %10, -225
  %13 = or i64 %12, 32
  %14 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %13, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
...
.loopexit39:                                      ; preds = %.preheader38, %389, %387
  ...
  %440 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %36, i64 %95, i64 %153, i64 %211, i64 %269, i64 %327, i64 %385, i64 %439) #23
  %441 = sub i64 %20, %29
...
458:                                              ; preds = %456
  %459 = and i64 %445, -225
  %460 = or i64 %459, 32
  %461 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %460, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
...
.loopexit24:                                      ; preds = %.preheader23, %836, %834
  ...
  %887 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %483, i64 %542, i64 %600, i64 %658, i64 %716, i64 %774, i64 %832, i64 %886) #23
  %888 = sub i64 %467, %476
...
__ockl_printf_append_string_n.exit5:              ; preds = %.loopexit24, %458
  ...
  %894 = and i64 %892, -225
  %895 = or i64 %894, 32
  %896 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %895, i64 %893, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
...
910:                                              ; preds = %908
  %911 = and i64 %897, -225
  %912 = or i64 %911, 32
  %913 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %912, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
...
.loopexit:                                        ; preds = %.preheader9, %1288, %1286
  ...
  %1339 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %8, i64 %935, i64 %994, i64 %1052, i64 %1110, i64 %1168, i64 %1226, i64 %1284, i64 %1338) #23
...
1354:                                             ; preds = %1349, %__ockl_printf_append_string_n.exit6
  ...
  tail call fastcc void @__ockl_printf_append_string_n(i64 %1356, i8* %0, i64 %1355)
...
define protected amdgpu_kernel void @_Z13GPU_laplace3diiiiPfS_(i32 %0, i32 %1, i32 %2, i32 %3, float addrspace(1)* nocapture readonly %4, float addrspace(1)* nocapture %5) local_unnamed_addr #3 {
  ...
  %8 = add nsw i32 %1, -1
  %9 = add nsw i32 %2, -1
  %10 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1xE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"*)) #20
  %11 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1yE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"*)) #20
  %12 = shl i32 %11, 5
  %13 = add i32 %12, %10
...
unify.bb:                                         ; preds = %6
  %15 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1yE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"*)) #20
  %16 = icmp ult i32 %15, 2
  br i1 %16, label %predication.split, label %predication.tail

17:                                               ; preds = %predication.tail, %6
  %.0105 = phi i32 [ undef, %6 ], [ %136, %predication.tail ]
  %.0104.in = phi i1 [ false, %6 ], [ %spec.select211, %predication.tail ]
  %.097 = phi i32 [ undef, %6 ], [ %144, %predication.tail ]
  %18 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1xE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"*)) #20
  %19 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1yE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"*)) #20
  %20 = add nsw i32 %18, 1
  %21 = add nsw i32 %19, 1
  %22 = tail call fastcc i32 @_ZL7__mul24ii(i32 %21, i32 34) #20
  %23 = add nsw i32 %20, %22
  %24 = add nsw i32 %23, 204
  %25 = tail call i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::X"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_BlockIdx>::X" addrspace(4)* @_ZN17__HIP_CoordinatesI14__HIP_BlockIdxE1xE to %"struct.__HIP_Coordinates<__HIP_BlockIdx>::X"*)) #20
  %26 = tail call fastcc i32 @_ZL7__mul24ii(i32 %25, i32 32) #20
  %27 = add nsw i32 %26, %18
  %28 = tail call i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI14__HIP_BlockIdxE1yE to %"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y"*)) #20
  %29 = tail call fastcc i32 @_ZL7__mul24ii(i32 %28, i32 4) #20
  %30 = add nsw i32 %29, %19
  %31 = tail call fastcc i32 @_ZL7__mul24ii(i32 %30, i32 %3) #20
...
36:                                               ; preds = %17
  ...
  %39 = bitcast float addrspace(1)* %38 to i32 addrspace(1)*
  %40 = add nsw i32 %23, 408
  %41 = getelementptr inbounds [612 x float], [612 x float] addrspace(3)* @_ZZ13GPU_laplace3diiiiPfS_E2u1, i32 0, i32 %40
  %42 = bitcast float addrspace(3)* %41 to i32 addrspace(3)*
  %43 = load i32, i32 addrspace(1)* %39, align 4
  store i32 %43, i32 addrspace(3)* %42, align 4
  br label %44
...
45:                                               ; preds = %44
  ...
  %49 = add nsw i32 %.0105, 204
  %50 = getelementptr inbounds [612 x float], [612 x float] addrspace(3)* @_ZZ13GPU_laplace3diiiiPfS_E2u1, i32 0, i32 %49
  %51 = bitcast float addrspace(3)* %50 to i32 addrspace(3)*
  %52 = load i32, i32 addrspace(1)* %48, align 4
  store i32 %52, i32 addrspace(3)* %51, align 4
  br label %.preheader
...
88:                                               ; preds = %87
  %89 = tail call fastcc i32 @_ZL7__mul24ii(i32 %1, i32 %3) #20
...
100:                                              ; preds = %99
  %101 = tail call fastcc i32 @_ZL7__mul24ii(i32 %1, i32 %3) #20
...
111:                                              ; preds = %106, %100, %99
  %.2 = phi i32 [ %102, %106 ], [ %102, %100 ], [ %.198217, %99 ]
  tail call void @_Z13__syncthreadsv() #23
...
unify.bb124:                                      ; preds = %111
  ...
  %121 = or i1 %78, %120
  %122 = or i1 %115, %121
  br i1 %122, label %predication.tail6, label %predication.split5

123:                                              ; preds = %predication.tail6, %111
  tail call void @_Z13__syncthreadsv() #23
...
predication.split:                                ; preds = %unify.bb
  %125 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1xE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"*)) #20
  %126 = tail call i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI15__HIP_ThreadIdxE1yE to %"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"*)) #20
  br label %predication.tail

predication.tail:                                 ; preds = %predication.split, %unify.bb
  ...
  %.neg = mul i32 %129, -2
  %.decomposed = add i32 %.neg, %.frozen
  %merged.select = select i1 %16, i32 %128, i32 %.decomposed
  %130 = mul i32 %merged.select, %merged.select107
  %131 = add nsw i32 %130, -1
  %132 = add nsw i32 %129, -32
  %.0101 = select i1 %16, i32 %127, i32 %131
  %merged.select108 = select i1 %16, i32 %130, i32 %132
  %133 = add i32 %merged.select108, -1
  %134 = tail call fastcc i32 @_ZL7__mul24ii(i32 %merged.select108, i32 34) #20
  %135 = add i32 %134, 205
  %136 = add i32 %135, %.0101
  %137 = tail call i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::X"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_BlockIdx>::X" addrspace(4)* @_ZN17__HIP_CoordinatesI14__HIP_BlockIdxE1xE to %"struct.__HIP_Coordinates<__HIP_BlockIdx>::X"*)) #20
  %138 = tail call fastcc i32 @_ZL7__mul24ii(i32 %137, i32 32) #20
  %139 = add nsw i32 %.0101, %138
  %140 = tail call i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y"* nonnull dereferenceable(1) addrspacecast (%"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y" addrspace(4)* @_ZN17__HIP_CoordinatesI14__HIP_BlockIdxE1yE to %"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y"*)) #20
  %141 = tail call fastcc i32 @_ZL7__mul24ii(i32 %140, i32 4) #20
  %142 = add nsw i32 %133, %141
  %143 = tail call fastcc i32 @_ZL7__mul24ii(i32 %142, i32 %3) #20
  ...
  %spec.select = and i1 %148, %or.cond
  %spec.select211 = and i1 %145, %spec.select
  br label %17

predication.split5:                               ; preds = %unify.bb124
  %149 = load float, float addrspace(3)* %80, align 4
  %150 = load float, float addrspace(3)* %82, align 4
  %151 = fadd contract float %149, %150
  %152 = load float, float addrspace(3)* %84, align 4
  %153 = fadd contract float %151, %152
  %154 = load float, float addrspace(3)* %86, align 4
  %155 = fadd contract float %153, %154
  %156 = load float, float addrspace(3)* %56, align 4
  %157 = fadd contract float %155, %156
  br label %predication.tail6

predication.tail6:                                ; preds = %unify.bb124, %predication.split5
  %merged.select3 = phi float addrspace(3)* [ %54, %unify.bb124 ], [ %59, %predication.split5 ]
  %158 = phi float [ undef, %unify.bb124 ], [ %157, %predication.split5 ]
  %159 = load float, float addrspace(3)* %merged.select3, align 4
  %160 = fadd contract float %158, %159
  %161 = fmul contract float %160, 0x3FC5555560000000
  %162 = select i1 %122, float %159, float undef
  %163 = select i1 %122, float %159, float %161
  %164 = select i1 %116, float undef, float %162
  %165 = select i1 %116, float %162, float %163
  %166 = select i1 %78, float undef, float %164
  %167 = or i1 %78, %115
  %168 = select i1 %78, float %164, float %165
  %169 = select i1 %74, float undef, float %166
  %170 = select i1 %74, float %166, float %168
  %171 = or i1 %74, %167
  %172 = or i1 %71, %171
  %173 = select i1 %172, float undef, float %162
  %174 = select i1 %71, float %169, float %170
  %.0102 = select i1 %69, float %173, float %174
  %175 = sext i32 %.1100 to i64
  %176 = getelementptr inbounds float, float addrspace(1)* %5, i64 %175
  store float %.0102, float addrspace(1)* %176, align 4
  br label %123
}
...
define linkonce_odr hidden i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::X"* nonnull dereferenceable(1) %0) local_unnamed_addr #4 comdat align 2 {
  ...
  %4 = call i32 @_ZNK15__HIP_ThreadIdxclEj(%struct.__HIP_ThreadIdx* nonnull dereferenceable(1) %3, i32 0) #20
  ret i32 %4
}
...
define linkonce_odr hidden i32 @_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_ThreadIdx>::Y"* nonnull dereferenceable(1) %0) local_unnamed_addr #4 comdat align 2 {
  %2 = alloca %struct.__HIP_ThreadIdx, align 1, addrspace(5)
  %3 = addrspacecast %struct.__HIP_ThreadIdx addrspace(5)* %2 to %struct.__HIP_ThreadIdx*
  %4 = call i32 @_ZNK15__HIP_ThreadIdxclEj(%struct.__HIP_ThreadIdx* nonnull dereferenceable(1) %3, i32 1) #20
  ret i32 %4
}
...
define linkonce_odr hidden i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1XcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::X"* nonnull dereferenceable(1) %0) local_unnamed_addr #4 comdat align 2 {
  ...
  %4 = call i32 @_ZNK14__HIP_BlockIdxclEj(%struct.__HIP_BlockIdx* nonnull dereferenceable(1) %3, i32 0) #20
  ret i32 %4
}
...
define linkonce_odr hidden i32 @_ZNK17__HIP_CoordinatesI14__HIP_BlockIdxE1YcvjEv(%"struct.__HIP_Coordinates<__HIP_BlockIdx>::Y"* nonnull dereferenceable(1) %0) local_unnamed_addr #4 comdat align 2 {
  %2 = alloca %struct.__HIP_BlockIdx, align 1, addrspace(5)
  %3 = addrspacecast %struct.__HIP_BlockIdx addrspace(5)* %2 to %struct.__HIP_BlockIdx*
  %4 = call i32 @_ZNK14__HIP_BlockIdxclEj(%struct.__HIP_BlockIdx* nonnull dereferenceable(1) %3, i32 1) #20
  ret i32 %4
}

; Function Attrs: convergent noinline nounwind mustprogress
define linkonce_odr hidden void @_Z13__syncthreadsv() local_unnamed_addr #6 comdat {
  tail call fastcc void @_ZL9__barrieri() #23
  ret void
}

; Function Attrs: convergent noinline nounwind mustprogress
define internal fastcc void @_ZL9__barrieri() unnamed_addr #6 {
  tail call fastcc void @_ZL20__work_group_barrierj14__memory_scope() #23
  ret void
}

; Function Attrs: convergent noinline nounwind
define internal fastcc void @_ZL20__work_group_barrierj14__memory_scope() unnamed_addr #7 {
...
define linkonce_odr hidden i32 @_ZNK15__HIP_ThreadIdxclEj(%struct.__HIP_ThreadIdx* nonnull dereferenceable(1) %0, i32 %1) local_unnamed_addr #9 comdat align 2 {
...
3:                                                ; preds = %2
  %4 = tail call i32 @llvm.amdgcn.workitem.id.x() #20, !range !11
  br label %__ockl_get_local_id.exit

5:                                                ; preds = %2
  %6 = tail call i32 @llvm.amdgcn.workitem.id.y() #20, !range !11
  br label %__ockl_get_local_id.exit

7:                                                ; preds = %2
  %8 = tail call i32 @llvm.amdgcn.workitem.id.z() #20, !range !11
  br label %__ockl_get_local_id.exit

__ockl_get_local_id.exit:                         ; preds = %7, %5, %3, %2
  %9 = phi i32 [ %8, %7 ], [ %6, %5 ], [ %4, %3 ], [ 0, %2 ]
  ret i32 %9
}

; Function Attrs: noinline nounwind
define linkonce_odr hidden i32 @_ZNK14__HIP_BlockIdxclEj(%struct.__HIP_BlockIdx* nonnull dereferenceable(1) %0, i32 %1) local_unnamed_addr #9 comdat align 2 {
...
3:                                                ; preds = %2
  %4 = tail call i32 @llvm.amdgcn.workgroup.id.x() #20
  br label %__ockl_get_group_id.exit

5:                                                ; preds = %2
  %6 = tail call i32 @llvm.amdgcn.workgroup.id.y() #20
  br label %__ockl_get_group_id.exit

7:                                                ; preds = %2
  %8 = tail call i32 @llvm.amdgcn.workgroup.id.z() #20
  br label %__ockl_get_group_id.exit

__ockl_get_group_id.exit:                         ; preds = %7, %5, %3, %2
  %9 = phi i32 [ %8, %7 ], [ %6, %5 ], [ %4, %3 ], [ 0, %2 ]
  ret i32 %9
}

; Function Attrs: nounwind readnone speculatable willreturn
declare align 4 i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr() #10

; Function Attrs: convergent noinline norecurse nounwind optnone
define internal fastcc <2 x i64> @__ockl_hostcall_internal(i8* %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) unnamed_addr #11 {
  ...
  call void @llvm.lifetime.start.p5i8(i64 4, i8 addrspace(5)* %27) #20
  %28 = call i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0) #20
  %29 = call i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 %28) #20
  store i32 %29, i32 addrspace(5)* %20, align 4, !tbaa !14
  %30 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !14
  %31 = call fastcc i32 @0(i32 %30) #24
  store i32 %31, i32 addrspace(5)* %20, align 4, !tbaa !14
  %32 = bitcast i32 addrspace(5)* %21 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 4, i8 addrspace(5)* %32) #20
  %33 = load i32, i32 addrspace(5)* %20, align 4, !tbaa !14
  %34 = call i32 @llvm.amdgcn.readfirstlane(i32 %33)
  store i32 %34, i32 addrspace(5)* %21, align 4, !tbaa !14
  %35 = bitcast %0 addrspace(1)* addrspace(5)* %22 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %35) #20
  ...
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %38) #20
  ...
  %42 = call fastcc i64 @1(%0 addrspace(1)* %39, i32 %40, i32 %41) #24
  store i64 %42, i64 addrspace(5)* %23, align 8, !tbaa !4
  %43 = bitcast %1 addrspace(1)* addrspace(5)* %24 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %43) #20
  ...
  %50 = call fastcc %1 addrspace(1)* @2(%1 addrspace(1)* %47, i64 %49, i64 %45) #24
  ...
  call void @llvm.lifetime.start.p5i8(i64 8, i8 addrspace(5)* %51) #20
  ...
  %58 = call fastcc %2 addrspace(1)* @3(%2 addrspace(1)* %55, i64 %57, i64 %53) #24
  ...
  call fastcc void @4(%1 addrspace(1)* %59, %2 addrspace(1)* %60, i32 %61, i64 %62, i64 %63, i64 %64, i64 %65, i64 %66, i64 %67, i64 %68, i64 %69, i32 %70, i32 %71) #24
  ...
  call fastcc void @5(%0 addrspace(1)* %72, i64 %73, i32 %74, i32 %75) #24
  %76 = bitcast <2 x i64> addrspace(5)* %26 to i8 addrspace(5)*
  call void @llvm.lifetime.start.p5i8(i64 16, i8 addrspace(5)* %76) #20
  ...
  %81 = call fastcc <2 x i64> @6(%1 addrspace(1)* %77, %2 addrspace(1)* %78, i32 %79, i32 %80) #24
  ...
  call fastcc void @7(%0 addrspace(1)* %82, i64 %83, i32 %84, i32 %85) #24
  %86 = load <2 x i64>, <2 x i64> addrspace(5)* %26, align 16, !tbaa !8
  %87 = bitcast <2 x i64> addrspace(5)* %26 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 16, i8 addrspace(5)* %87) #20
  %88 = bitcast %2 addrspace(1)* addrspace(5)* %25 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 8, i8 addrspace(5)* %88) #20
  %89 = bitcast %1 addrspace(1)* addrspace(5)* %24 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 8, i8 addrspace(5)* %89) #20
  %90 = bitcast i64 addrspace(5)* %23 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 8, i8 addrspace(5)* %90) #20
  %91 = bitcast %0 addrspace(1)* addrspace(5)* %22 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 8, i8 addrspace(5)* %91) #20
  %92 = bitcast i32 addrspace(5)* %21 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 4, i8 addrspace(5)* %92) #20
  %93 = bitcast i32 addrspace(5)* %20 to i8 addrspace(5)*
  call void @llvm.lifetime.end.p5i8(i64 4, i8 addrspace(5)* %93) #20
  ret <2 x i64> %86
}

; Function Attrs: argmemonly nofree nosync nounwind willreturn
declare void @llvm.lifetime.start.p5i8(i64 immarg, i8 addrspace(5)* nocapture) #12

; Function Attrs: convergent norecurse nounwind
define internal fastcc i32 @0(i32 %0) unnamed_addr #13 {
  %2 = tail call i32 asm sideeffect "; ockl readfirstlane hoisting hack $0", "=v,0"(i32 %0) #23, !srcloc !21
  ret i32 %2
}
...
; Function Attrs: convergent norecurse nounwind
define internal fastcc i64 @1(%0 addrspace(1)* nocapture %0, i32 %1, i32 %2) unnamed_addr #13 {
  %4 = icmp eq i32 %1, %2
...
.preheader:                                       ; preds = %5, %.preheader
  ...
  tail call void @llvm.amdgcn.s.sleep(i32 1) #20
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %5, %3
  %27 = phi i64 [ 0, %3 ], [ %7, %5 ], [ %26, %.loopexit.loopexit ]
  %28 = trunc i64 %27 to i32
  %29 = lshr i64 %27, 32
  %30 = trunc i64 %29 to i32
  %31 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %28)
  %32 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %30)
...
define internal fastcc %1 addrspace(1)* @2(%1 addrspace(1)* readnone %0, i64 %1, i64 %2) unnamed_addr #15 {
  %4 = and i64 %2, %1
...
; Function Attrs: norecurse nounwind readnone
define internal fastcc %2 addrspace(1)* @3(%2 addrspace(1)* readnone %0, i64 %1, i64 %2) unnamed_addr #15 {
  %4 = and i64 %2, %1
...
define internal fastcc void @4(%1 addrspace(1)* nocapture %0, %2 addrspace(1)* nocapture %1, i32 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, i32 %11, i32 %12) unnamed_addr #16 {
  %14 = tail call i64 @llvm.read_register.i64(metadata !22) #24
...
16:                                               ; preds = %13
  ...
  store i32 %2, i32 addrspace(1)* %19, align 8, !tbaa !23
  store i64 %14, i64 addrspace(1)* %18, align 8, !tbaa !25
  store i32 1, i32 addrspace(1)* %17, align 4, !tbaa !26
  br label %20
...
; Function Attrs: convergent norecurse nounwind
define internal fastcc void @5(%0 addrspace(1)* nocapture %0, i64 %1, i32 %2, i32 %3) unnamed_addr #13 {
  %5 = icmp eq i32 %2, %3
...
29:                                               ; preds = %.loopexit
  ...
  %34 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %32) #20
  %35 = and i32 %34, 255
  tail call void @llvm.amdgcn.s.sendmsg(i32 1, i32 %35) #20
...
; Function Attrs: convergent norecurse nounwind
define internal fastcc <2 x i64> @6(%1 addrspace(1)* nocapture readonly %0, %2 addrspace(1)* nocapture readonly %1, i32 %2, i32 %3) unnamed_addr #17 {
  %5 = icmp eq i32 %2, %3
...
define internal fastcc void @7(%0 addrspace(1)* nocapture %0, i64 %1, i32 %2, i32 %3) unnamed_addr #18 {
  %5 = icmp eq i32 %2, %3
...
; Function Attrs: argmemonly nofree nosync nounwind willreturn
declare void @llvm.lifetime.end.p5i8(i64 immarg, i8 addrspace(5)* nocapture) #12

; Function Attrs: nounwind willreturn
declare void @llvm.amdgcn.s.sleep(i32 immarg) #19

; Function Attrs: nounwind
declare void @llvm.amdgcn.s.sendmsg(i32 immarg, i32) #20

; Function Attrs: nounwind readonly
declare i64 @llvm.read_register.i64(metadata) #21

; Function Attrs: nounwind readnone willreturn
declare i32 @llvm.amdgcn.mbcnt.lo(i32, i32) #22

; Function Attrs: nounwind readnone willreturn
declare i32 @llvm.amdgcn.mbcnt.hi(i32, i32) #22

; Function Attrs: convergent norecurse nounwind
define internal fastcc void @__ockl_printf_append_string_n(i64 %0, i8* readonly %1, i64 %2) unnamed_addr #17 {
  %4 = icmp eq i8* %1, null
...
5:                                                ; preds = %3
  %6 = and i64 %0, -227
  %7 = or i64 %6, 34
  %8 = tail call i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr() #20
  %9 = getelementptr inbounds i8, i8 addrspace(4)* %8, i64 24
  %10 = bitcast i8 addrspace(4)* %9 to i64 addrspace(4)*
  %11 = load i64, i64 addrspace(4)* %10, align 8, !tbaa !4
  %12 = inttoptr i64 %11 to i8*
  %13 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %12, i64 %7, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #23
  br label %.loopexit26

14:                                               ; preds = %3
  %15 = and i64 %0, -3
  %16 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %15, i64 0
  %17 = tail call i8 addrspace(4)* @llvm.amdgcn.implicitarg.ptr() #20
  %18 = getelementptr inbounds i8, i8 addrspace(4)* %17, i64 24
  %19 = bitcast i8 addrspace(4)* %18 to i64 addrspace(4)*
  %20 = load i64, i64 addrspace(4)* %19, align 8, !tbaa !4
  %21 = inttoptr i64 %20 to i8*
  br label %22

22:                                               ; preds = %.loopexit, %14
  %23 = phi i64 [ %2, %14 ], [ %444, %.loopexit ]
  %24 = phi i8* [ %1, %14 ], [ %445, %.loopexit ]
  %25 = phi <2 x i64> [ %16, %14 ], [ %443, %.loopexit ]
  ...
  %32 = select i1 %31, i64 %23, i64 56
  %33 = trunc i64 %32 to i32
  %34 = extractelement <2 x i64> %30, i64 0
  %35 = and i64 %34, -225
  %36 = shl nuw nsw i64 %32, 2
  %37 = add nuw nsw i64 %36, 28
  %38 = and i64 %37, 480
  %39 = or i64 %35, %38
  %40 = icmp ugt i32 %33, 7
  br i1 %40, label %43, label %41

41:                                               ; preds = %22
  %42 = icmp eq i32 %33, 0
  br i1 %42, label %.loopexit25, label %.preheader24

43:                                               ; preds = %22
  %44 = load i8, i8* %24, align 1, !tbaa !8
  %45 = zext i8 %44 to i64
  %46 = getelementptr inbounds i8, i8* %24, i64 1
  ...
  %65 = or i64 %60, %64
  %66 = getelementptr inbounds i8, i8* %24, i64 5
  %67 = load i8, i8* %66, align 1, !tbaa !8
  %68 = zext i8 %67 to i64
  %69 = shl nuw nsw i64 %68, 40
  %70 = or i64 %65, %69
  %71 = getelementptr inbounds i8, i8* %24, i64 6
  %72 = load i8, i8* %71, align 1, !tbaa !8
  %73 = zext i8 %72 to i64
  %74 = shl nuw nsw i64 %73, 48
  %75 = or i64 %70, %74
  %76 = getelementptr inbounds i8, i8* %24, i64 7
...
.preheader24:                                     ; preds = %41, %.preheader24
  %83 = phi i32 [ %94, %.preheader24 ], [ 0, %41 ]
  %84 = phi i64 [ %93, %.preheader24 ], [ 0, %41 ]
  ...
  br i1 %95, label %.loopexit25, label %.preheader24

.loopexit25:                                      ; preds = %.preheader24, %43, %41
  %96 = phi i8* [ %82, %43 ], [ %24, %41 ], [ %24, %.preheader24 ]
  %97 = phi i32 [ %81, %43 ], [ 0, %41 ], [ 0, %.preheader24 ]
  %98 = phi i64 [ %80, %43 ], [ 0, %41 ], [ %93, %.preheader24 ]
  %99 = icmp ugt i32 %97, 7
  br i1 %99, label %102, label %100

100:                                              ; preds = %.loopexit25
  %101 = icmp eq i32 %97, 0
  br i1 %101, label %.loopexit23, label %.preheader22

102:                                              ; preds = %.loopexit25
  %103 = load i8, i8* %96, align 1, !tbaa !8
  %104 = zext i8 %103 to i64
...
.preheader22:                                     ; preds = %100, %.preheader22
  ...
  br i1 %153, label %.loopexit23, label %.preheader22

.loopexit23:                                      ; preds = %.preheader22, %102, %100
  %154 = phi i8* [ %141, %102 ], [ %96, %100 ], [ %96, %.preheader22 ]
  %155 = phi i32 [ %140, %102 ], [ 0, %100 ], [ 0, %.preheader22 ]
  %156 = phi i64 [ %139, %102 ], [ 0, %100 ], [ %151, %.preheader22 ]
  %157 = icmp ugt i32 %155, 7
  br i1 %157, label %160, label %158

158:                                              ; preds = %.loopexit23
  %159 = icmp eq i32 %155, 0
  br i1 %159, label %.loopexit21, label %.preheader20

160:                                              ; preds = %.loopexit23
  %161 = load i8, i8* %154, align 1, !tbaa !8
  %162 = zext i8 %161 to i64
...
.preheader20:                                     ; preds = %158, %.preheader20
  ...
  %211 = icmp eq i32 %210, %155
  br i1 %211, label %.loopexit21, label %.preheader20

.loopexit21:                                      ; preds = %.preheader20, %160, %158
  %212 = phi i8* [ %199, %160 ], [ %154, %158 ], [ %154, %.preheader20 ]
  %213 = phi i32 [ %198, %160 ], [ 0, %158 ], [ 0, %.preheader20 ]
  %214 = phi i64 [ %197, %160 ], [ 0, %158 ], [ %209, %.preheader20 ]
  %215 = icmp ugt i32 %213, 7
  br i1 %215, label %218, label %216

216:                                              ; preds = %.loopexit21
  %217 = icmp eq i32 %213, 0
  br i1 %217, label %.loopexit19, label %.preheader18

218:                                              ; preds = %.loopexit21
  %219 = load i8, i8* %212, align 1, !tbaa !8
  %220 = zext i8 %219 to i64
  %221 = getelementptr inbounds i8, i8* %212, i64 1
  %222 = load i8, i8* %221, align 1, !tbaa !8
  %223 = zext i8 %222 to i64
  %224 = shl nuw nsw i64 %223, 8
  %225 = or i64 %224, %220
  %226 = getelementptr inbounds i8, i8* %212, i64 2
  %227 = load i8, i8* %226, align 1, !tbaa !8
  %228 = zext i8 %227 to i64
  %229 = shl nuw nsw i64 %228, 16
  %230 = or i64 %225, %229
  %231 = getelementptr inbounds i8, i8* %212, i64 3
  %232 = load i8, i8* %231, align 1, !tbaa !8
  %233 = zext i8 %232 to i64
  %234 = shl nuw nsw i64 %233, 24
  %235 = or i64 %230, %234
  %236 = getelementptr inbounds i8, i8* %212, i64 4
  %237 = load i8, i8* %236, align 1, !tbaa !8
  %238 = zext i8 %237 to i64
  %239 = shl nuw nsw i64 %238, 32
  %240 = or i64 %235, %239
  %241 = getelementptr inbounds i8, i8* %212, i64 5
  %242 = load i8, i8* %241, align 1, !tbaa !8
  %243 = zext i8 %242 to i64
  %244 = shl nuw nsw i64 %243, 40
  %245 = or i64 %240, %244
  %246 = getelementptr inbounds i8, i8* %212, i64 6
  %247 = load i8, i8* %246, align 1, !tbaa !8
  %248 = zext i8 %247 to i64
  %249 = shl nuw nsw i64 %248, 48
  %250 = or i64 %245, %249
  %251 = getelementptr inbounds i8, i8* %212, i64 7
  %252 = load i8, i8* %251, align 1, !tbaa !8
  %253 = zext i8 %252 to i64
  %254 = shl nuw i64 %253, 56
  %255 = or i64 %250, %254
  %256 = add i32 %213, -8
  %257 = getelementptr inbounds i8, i8* %212, i64 8
  br label %.loopexit19

.preheader18:                                     ; preds = %216, %.preheader18
  %258 = phi i32 [ %268, %.preheader18 ], [ 0, %216 ]
  %259 = phi i64 [ %267, %.preheader18 ], [ 0, %216 ]
  %260 = zext i32 %258 to i64
  %261 = getelementptr inbounds i8, i8* %212, i64 %260
  %262 = load i8, i8* %261, align 1, !tbaa !8
  ...
  br i1 %269, label %.loopexit19, label %.preheader18

.loopexit19:                                      ; preds = %.preheader18, %218, %216
  %270 = phi i8* [ %257, %218 ], [ %212, %216 ], [ %212, %.preheader18 ]
  %271 = phi i32 [ %256, %218 ], [ 0, %216 ], [ 0, %.preheader18 ]
  %272 = phi i64 [ %255, %218 ], [ 0, %216 ], [ %267, %.preheader18 ]
  %273 = icmp ugt i32 %271, 7
  br i1 %273, label %276, label %274

274:                                              ; preds = %.loopexit19
  %275 = icmp eq i32 %271, 0
  br i1 %275, label %.loopexit17, label %.preheader16

276:                                              ; preds = %.loopexit19
  %277 = load i8, i8* %270, align 1, !tbaa !8
  %278 = zext i8 %277 to i64
  %279 = getelementptr inbounds i8, i8* %270, i64 1
  %280 = load i8, i8* %279, align 1, !tbaa !8
  %281 = zext i8 %280 to i64
  %282 = shl nuw nsw i64 %281, 8
  %283 = or i64 %282, %278
  %284 = getelementptr inbounds i8, i8* %270, i64 2
  %285 = load i8, i8* %284, align 1, !tbaa !8
  %286 = zext i8 %285 to i64
  %287 = shl nuw nsw i64 %286, 16
  %288 = or i64 %283, %287
  %289 = getelementptr inbounds i8, i8* %270, i64 3
  %290 = load i8, i8* %289, align 1, !tbaa !8
  %291 = zext i8 %290 to i64
  %292 = shl nuw nsw i64 %291, 24
  %293 = or i64 %288, %292
  %294 = getelementptr inbounds i8, i8* %270, i64 4
  %295 = load i8, i8* %294, align 1, !tbaa !8
  %296 = zext i8 %295 to i64
  %297 = shl nuw nsw i64 %296, 32
  %298 = or i64 %293, %297
  %299 = getelementptr inbounds i8, i8* %270, i64 5
  %300 = load i8, i8* %299, align 1, !tbaa !8
  %301 = zext i8 %300 to i64
  %302 = shl nuw nsw i64 %301, 40
  %303 = or i64 %298, %302
  %304 = getelementptr inbounds i8, i8* %270, i64 6
  %305 = load i8, i8* %304, align 1, !tbaa !8
  %306 = zext i8 %305 to i64
  %307 = shl nuw nsw i64 %306, 48
  %308 = or i64 %303, %307
  %309 = getelementptr inbounds i8, i8* %270, i64 7
  %310 = load i8, i8* %309, align 1, !tbaa !8
  %311 = zext i8 %310 to i64
  %312 = shl nuw i64 %311, 56
  %313 = or i64 %308, %312
  %314 = add i32 %271, -8
  %315 = getelementptr inbounds i8, i8* %270, i64 8
  br label %.loopexit17

.preheader16:                                     ; preds = %274, %.preheader16
  %316 = phi i32 [ %326, %.preheader16 ], [ 0, %274 ]
  %317 = phi i64 [ %325, %.preheader16 ], [ 0, %274 ]
  %318 = zext i32 %316 to i64
  %319 = getelementptr inbounds i8, i8* %270, i64 %318
  %320 = load i8, i8* %319, align 1, !tbaa !8
  ...
  %327 = icmp eq i32 %326, %271
  br i1 %327, label %.loopexit17, label %.preheader16

.loopexit17:                                      ; preds = %.preheader16, %276, %274
  %328 = phi i8* [ %315, %276 ], [ %270, %274 ], [ %270, %.preheader16 ]
  %329 = phi i32 [ %314, %276 ], [ 0, %274 ], [ 0, %.preheader16 ]
  %330 = phi i64 [ %313, %276 ], [ 0, %274 ], [ %325, %.preheader16 ]
  %331 = icmp ugt i32 %329, 7
  br i1 %331, label %334, label %332

332:                                              ; preds = %.loopexit17
  %333 = icmp eq i32 %329, 0
  br i1 %333, label %.loopexit15, label %.preheader14

334:                                              ; preds = %.loopexit17
  %335 = load i8, i8* %328, align 1, !tbaa !8
  %336 = zext i8 %335 to i64
  %337 = getelementptr inbounds i8, i8* %328, i64 1
  %338 = load i8, i8* %337, align 1, !tbaa !8
  %339 = zext i8 %338 to i64
  %340 = shl nuw nsw i64 %339, 8
  %341 = or i64 %340, %336
  %342 = getelementptr inbounds i8, i8* %328, i64 2
  %343 = load i8, i8* %342, align 1, !tbaa !8
  %344 = zext i8 %343 to i64
  %345 = shl nuw nsw i64 %344, 16
  %346 = or i64 %341, %345
  %347 = getelementptr inbounds i8, i8* %328, i64 3
  %348 = load i8, i8* %347, align 1, !tbaa !8
  %349 = zext i8 %348 to i64
  %350 = shl nuw nsw i64 %349, 24
  %351 = or i64 %346, %350
  %352 = getelementptr inbounds i8, i8* %328, i64 4
  %353 = load i8, i8* %352, align 1, !tbaa !8
  %354 = zext i8 %353 to i64
  %355 = shl nuw nsw i64 %354, 32
  %356 = or i64 %351, %355
  %357 = getelementptr inbounds i8, i8* %328, i64 5
  %358 = load i8, i8* %357, align 1, !tbaa !8
  %359 = zext i8 %358 to i64
  %360 = shl nuw nsw i64 %359, 40
  %361 = or i64 %356, %360
  %362 = getelementptr inbounds i8, i8* %328, i64 6
  %363 = load i8, i8* %362, align 1, !tbaa !8
  %364 = zext i8 %363 to i64
  %365 = shl nuw nsw i64 %364, 48
  %366 = or i64 %361, %365
  %367 = getelementptr inbounds i8, i8* %328, i64 7
  %368 = load i8, i8* %367, align 1, !tbaa !8
  %369 = zext i8 %368 to i64
  %370 = shl nuw i64 %369, 56
  %371 = or i64 %366, %370
  %372 = add i32 %329, -8
  %373 = getelementptr inbounds i8, i8* %328, i64 8
  br label %.loopexit15

.preheader14:                                     ; preds = %332, %.preheader14
  %374 = phi i32 [ %384, %.preheader14 ], [ 0, %332 ]
  %375 = phi i64 [ %383, %.preheader14 ], [ 0, %332 ]
  %376 = zext i32 %374 to i64
  %377 = getelementptr inbounds i8, i8* %328, i64 %376
  %378 = load i8, i8* %377, align 1, !tbaa !8
  ...
  %385 = icmp eq i32 %384, %329
  br i1 %385, label %.loopexit15, label %.preheader14

.loopexit15:                                      ; preds = %.preheader14, %334, %332
  %386 = phi i8* [ %373, %334 ], [ %328, %332 ], [ %328, %.preheader14 ]
  %387 = phi i32 [ %372, %334 ], [ 0, %332 ], [ 0, %.preheader14 ]
  %388 = phi i64 [ %371, %334 ], [ 0, %332 ], [ %383, %.preheader14 ]
...
392:                                              ; preds = %.loopexit15
  %393 = load i8, i8* %386, align 1, !tbaa !8
  %394 = zext i8 %393 to i64
  %395 = getelementptr inbounds i8, i8* %386, i64 1
  %396 = load i8, i8* %395, align 1, !tbaa !8
...
.preheader:                                       ; preds = %390, %.preheader
  %430 = phi i32 [ %440, %.preheader ], [ 0, %390 ]
  %431 = phi i64 [ %439, %.preheader ], [ 0, %390 ]
  %432 = zext i32 %430 to i64
  %433 = getelementptr inbounds i8, i8* %386, i64 %432
  %434 = load i8, i8* %433, align 1, !tbaa !8
  ...
  %441 = icmp eq i32 %440, %387
  br i1 %441, label %.loopexit, label %.preheader

.loopexit:                                        ; preds = %.preheader, %392, %390
  %442 = phi i64 [ %429, %392 ], [ 0, %390 ], [ %439, %.preheader ]
  %443 = tail call fastcc <2 x i64> @__ockl_hostcall_internal(i8* %21, i64 %39, i64 %98, i64 %156, i64 %214, i64 %272, i64 %330, i64 %388, i64 %442) #23
  %444 = sub i64 %23, %32
  %445 = getelementptr inbounds i8, i8* %24, i64 %32
  %446 = icmp eq i64 %444, 0
  br i1 %446, label %.loopexit26, label %22

.loopexit26:                                      ; preds = %.loopexit, %5
  ret void
}
...
attributes #16 = { convergent nofree norecurse nounwind "amdgpu-unsafe-fp-atomics"="true" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #17 = { convergent norecurse nounwind "amdgpu-unsafe-fp-atomics"="true" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="128" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #18 = { norecurse nounwind "amdgpu-unsafe-fp-atomics"="true" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
